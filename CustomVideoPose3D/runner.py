...
dataset_path = 'data/data_3d_' + 'custom' + '.npz'

from common.custom_dataset import CustomDataset
dataset = CustomDataset('data/data_2d_' + 'custom' + '_' + 'joints' + '.npz')
...
keypoints = np.load('data/data_2d_' + 'custom'  + '_' + 'joints' + '.npz', allow_pickle=True)
...
print('Exporting joint positions to', "pose")
    # Predictions are in camera space
np.save("pose", prediction)
